...
The Task64 frontend all repackaged as an electron app to run as a desktop app!
...
sed -i 's/\/api\/v1//g' frontend/index.html # Make sure to trigger the "enter the Task64 url" prompt
```

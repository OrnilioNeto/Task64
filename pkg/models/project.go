...
// @Param expand query string false "If set to `permissions`, Task64 will return the max permission the current user has on this project. You can currently only set this to `permissions`."
// @Security JWTKeyAuth

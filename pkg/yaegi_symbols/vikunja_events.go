// Code generated by 'yaegi extract github.com/OrnilioNeto/Task64/pkg/events'. DO NOT EDIT.
...
func init() {
	Symbols["github.com/OrnilioNeto/Task64/pkg/events/events"] = map[string]reflect.Value{
		...
		"MetadataSkipErrorReporting": reflect.ValueOf(constant.MakeFromLiteral("\"skip_error_reporting\"", token.STRING, 0)),
		...
		"_Event":    reflect.ValueOf((*_code_task64_io_api_pkg_events_Event)(nil)),
		"_Listener": reflect.ValueOf((*_code_task64_io_api_pkg_events_Listener)(nil)),
	}
}

// _code_task64_io_api_pkg_events_Event is an interface wrapper for Event type
type _code_task64_io_api_pkg_events_Event struct {
	IValue interface{}
	WName  func() string
}

func (W _code_task64_io_api_pkg_events_Event) Name() string {
	return W.WName()
}

// _code_task64_io_api_pkg_events_Listener is an interface wrapper for Listener type
type _code_task64_io_api_pkg_events_Listener struct {
	IValue  interface{}
	WHandle func(msg *message.Message) error
	WName   func() string
}

func (W _code_task64_io_api_pkg_events_Listener) Handle(msg *message.Message) error {
	return W.WHandle(msg)
}
func (W _code_task64_io_api_pkg_events_Listener) Name() string {
	return W.WName()
}

// Code generated by 'yaegi extract github.com/OrnilioNeto/Task64/pkg/log'. DO NOT EDIT.
...
func init() {
	Symbols["github.com/OrnilioNeto/Task64/pkg/log/log"] = map[string]reflect.Value{

// Code generated by 'yaegi extract github.com/OrnilioNeto/Task64/pkg/config'. DO NOT EDIT.
...
func init() {
	Symbols["github.com/OrnilioNeto/Task64/pkg/config/config"] = map[string]reflect.Value{

// Code generated by 'yaegi extract github.com/OrnilioNeto/Task64/pkg/user'. DO NOT EDIT.
...
func init() {
	Symbols["github.com/OrnilioNeto/Task64/pkg/user/user"] = map[string]reflect.Value{
		// function, constant and variable definitions
		"AuthTypeUser":                         reflect.ValueOf(user.AuthTypeUser),
		"CancelDeletion":                       reflect.ValueOf(user.CancelDeletion),
		"CancelEmailUpdate":                    reflect.ValueOf(user.CancelEmailUpdate),
		...
		"CleanupOldTokens":                     reflect.ValueOf(user.CleanupOldTokens),
		"ConfirmDeletion":                      reflect.ValueOf(user.ConfirmDeletion),
		"ConfirmEmail":                         reflect.ValueOf(user.ConfirmEmail),
		"CreateBotUser":                        reflect.ValueOf(user.CreateBotUser),
		...
		"EmailUpdateMessage":                   reflect.ValueOf(user.EmailUpdateMessage),
		...
		"ErrCodeEmailConfirmationCooldown":     reflect.ValueOf(constant.MakeFromLiteral("1036", token.INT, 0)),
		...
		"ErrCodeLastAdmin":                     reflect.ValueOf(constant.MakeFromLiteral("1030", token.INT, 0)),
		...
		"GuardLastAdmin":                       reflect.ValueOf(user.GuardLastAdmin),
		...
		"IsErrAccountIsBot":                    reflect.ValueOf(user.IsErrAccountIsBot),
		"IsErrAccountIsNotLocal":               reflect.ValueOf(user.IsErrAccountIsNotLocal),
		"IsErrAccountLocked":                   reflect.ValueOf(user.IsErrAccountLocked),
		"IsErrBotNotOwned":                     reflect.ValueOf(user.IsErrBotNotOwned),
		"IsErrBotUsernameMustHavePrefix":       reflect.ValueOf(user.IsErrBotUsernameMustHavePrefix),
		"IsErrCouldNotGetUserID":               reflect.ValueOf(user.IsErrCouldNotGetUserID),
		"IsErrEmailConfirmationCooldown":       reflect.ValueOf(user.IsErrEmailConfirmationCooldown),
		...
		"IsErrLastAdmin":                       reflect.ValueOf(user.IsErrLastAdmin),
		...
		"IsErrNoPendingEmail":                  reflect.ValueOf(user.IsErrNoPendingEmail),
		...
		"IsErrTOTPPasscodeUsed":                reflect.ValueOf(user.IsErrTOTPPasscodeUsed),
		...
		"IsErrUserStatusError":                 reflect.ValueOf(user.IsErrUserStatusError),
		...
		"StatusAccountLocked":                  reflect.ValueOf(user.StatusAccountLocked),
		...
		"ErrAccountIsBot":                                   reflect.ValueOf((*user.ErrAccountIsBot)(nil)),
		"ErrAccountIsNotLocal":                              reflect.ValueOf((*user.ErrAccountIsNotLocal)(nil)),
		"ErrAccountLocked":                                  reflect.ValueOf((*user.ErrAccountLocked)(nil)),
		"ErrBotNotOwned":                                    reflect.ValueOf((*user.ErrBotNotOwned)(nil)),
		"ErrBotUsernameMustHavePrefix":                      reflect.ValueOf((*user.ErrBotUsernameMustHavePrefix)(nil)),
		"ErrCouldNotGetUserID":                              reflect.ValueOf((*user.ErrCouldNotGetUserID)(nil)),
		"ErrEmailConfirmationCooldown":                      reflect.ValueOf((*user.ErrEmailConfirmationCooldown)(nil)),
		...
		"ErrLastAdmin":                                      reflect.ValueOf((*user.ErrLastAdmin)(nil)),
		...
		"ErrNoPendingEmail":                                 reflect.ValueOf((*user.ErrNoPendingEmail)(nil)),
		...
		"ErrTOTPPasscodeUsed":                               reflect.ValueOf((*user.ErrTOTPPasscodeUsed)(nil)),
		"ErrTOTPQrCodeNotAvailable":                         reflect.ValueOf((*user.ErrTOTPQrCodeNotAvailable)(nil)),
		...
		"LoginFailedEvent":                                  reflect.ValueOf((*user.LoginFailedEvent)(nil)),
		"LoginSucceededEvent":                               reflect.ValueOf((*user.LoginSucceededEvent)(nil)),
		"LogoutEvent":                                       reflect.ValueOf((*user.LogoutEvent)(nil)),

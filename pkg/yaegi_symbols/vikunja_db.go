// Code generated by 'yaegi extract github.com/OrnilioNeto/Task64/pkg/db'. DO NOT EDIT.
...
func init() {
	Symbols["github.com/OrnilioNeto/Task64/pkg/db/db"] = map[string]reflect.Value{

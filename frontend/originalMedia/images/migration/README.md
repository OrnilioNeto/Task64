...
The images in this directory are used by Task64's import feature to represent third-party services. Each logo is owned by its respective trademark holder:
...
These logos are provided only to show that Task64 can import tasks from these services. Their inclusion does not imply endorsement by the trademark owners. Do not use the logos except as allowed by the respective brand policies.

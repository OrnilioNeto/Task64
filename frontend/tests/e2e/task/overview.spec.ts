...
test.describe('Home Page Task Overview', () => {
	...
	test('Should show the cta buttons for new project when there are no tasks', async ({authenticatedPage: page}) => {
		...
		await expect(page.locator('.home.app-content .content')).toContainText('Import your projects and tasks from other services into Task64:')
	})
	...
	test('Should not show the cta buttons for new project when there are tasks', async ({authenticatedPage: page, apiContext}) => {
		...
		await expect(page.locator('.home.app-content .content')).not.toContainText('Or import your projects and tasks from other services into Task64:')
	})
})
